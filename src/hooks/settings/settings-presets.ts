// Preset arrays for app backgrounds, card frames, and themes
// Consumers: import from 'hooks/settings' or 'hooks/use-settings'

import type { AppBackgroundId, CardFrameId, GlobalTheme } from './settings-types';
...
export const THEME_PRESETS: Array<{ name: string; primary: string; dark: string; gradient: string }> = [
...
// Default theme value (used by useGlobalTheme)
...
export const THEME_STORAGE_KEY = 'flashcard-global-theme';
