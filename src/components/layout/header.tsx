...
export type Page = 'home' | 'cards' | 'study' | 'grammar-study' | 'kanji-study' | 'reading' | 'progress' | 'game-hub' | 'quiz' | 'golden-bell' | 'picture-guess' | 'jlpt' | 'kaiwa' | 'lectures' | 'lecture-editor' | 'chat' | 'settings' | 'profile' | 'classroom' | 'branches' | 'teachers' | 'salary' | 'my-teaching' | 'notifications' | 'daily-words' | 'listening' | 'exercises' | 'center-members' | 'center-dashboard';
