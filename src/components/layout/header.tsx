...
export type Page = 'home' | 'cards' | 'study' | 'progress' | 'game-hub' | 'quiz' | 'racing' | 'golden-bell' | 'picture-guess' | 'jlpt' | 'kaiwa' | 'lectures' | 'lecture-editor' | 'chat' | 'settings' | 'classroom' | 'branches' | 'teachers' | 'salary' | 'my-teaching' | 'notifications';
